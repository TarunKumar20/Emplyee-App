...
public class Search extends HttpServlet {
       ...
       public void doGet(HttpServletRequest request, HttpServletResponse response)
              ...
              try{
                     ...
                     PreparedStatement ps=con.prepareStatement("select * from TarunKumar_111915060_detail where ID_number=?");
                     PreparedStatement ps1=con.prepareStatement("select * from TarunKumar_111915060_salary where ID_number=?");
